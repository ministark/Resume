...
\textbf{Course Project} 
  \vspace{-4pt}
    \begin{itemize}[itemsep = -0.75 mm, leftmargin=*]
      \item Developed  movie recommendation engine in {\bf Python} using collaborative filtering technique \textbf{Euclidian distance} and \textbf{Pearson Correlation} to find relevant movies
      % \item 3D replication of famous game Tank in Unity each player has a tank that can fire shell any direction it wants
...
\hspace{-8pt}
  \begin{tabular}{p{30mm} p{14cm}}
  	\textbf{Theoretical CS} &Parallel Programming Paradigm, Artificial Learning, Foundation of Machine Learning, Automata Theory, Computer Graphics, Fundamentals of Digital Image Processing \\
