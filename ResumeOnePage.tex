...
% \end{tabular}
\hspace{-15 pt} 
Pursuing {\bf Honours} in Computer Science and {\bf Minor} in Humanities and Social Sciences\\
\vspace*{-20 pt}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Intern%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{\LARGE Self Projects\xfilll[0pt]{0.5pt}}
\vspace{-4pt}
...
\begin{tabular}{p{4.5cm} p{13.5cm}}
    \textbf{Programming} &C, C++, Java, Python, Bash, SQL, HLSL, C\#, R ,VHDL\\ \\
    \textbf{Development} &JavaScript, Django, Spring Framework, HTML5, CSS \\ \\ 
    \textbf{Softwares} &Git, Unity3D,  UnrealEngine, Andriod Studio, DirectX, OpenGL,\\ &\LaTeX, Makefiles, Wireshark, AutoCAD \& Solidwork \\
\end{tabular}
